from src.qlitreutils import sort


def test_bubble_sort():
    my_list = [6, 5, 8, 2]
    my_list = sort.bubble_sort(my_list)
    assert my_list == [2, 5, 6, 8]


def test_insertion_sort():
    my_list = [6, 5, 8, 2]
    my_list = sort.insertion_sort(my_list)
    assert my_list == [2, 5, 6, 8]


def test_merge_sort():
    my_list = [6, 5, 8, 2]
    my_list = sort.merge_sort(my_list)
    assert my_list == [2, 5, 6, 8]


def test_get_before_in_sorted_permutation():
    a_list = [3, 1, 2, 4, 7]
    ret = sort.get_before_in_sorted_permutation(a_list)
...
def test_get_after_in_sorted_permutation():
    a_list = [3, 1, 2, 4, 7]
    ret = sort.get_after_in_sorted_permutation(a_list)
